...
```{r fig.width=12,fig.height=4,out.width=400, echo=TRUE, eval=FALSE}
...
```{r fig.height=3,fig.width=12,out.height=200, echo=TRUE, eval=FALSE}
GRAPHDISTS(REPETITIONS = 2000 , BALLSSELLECTED = c(1,2,5,10) , DIST = "uniform" )
GRAPHDISTS(REPETITIONS = 2000 , BALLSSELLECTED = c(1,2,5,10) , DIST = "chisq2" )
